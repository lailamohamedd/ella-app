    ...
    <v-container fluid>
        <v-row>
            ...
            <v-col cols="12" class="pt-0">
                <v-card-title class="pl-0 pb-0 pr-2 d-flex justify-lg-space-between align-center w-100" style="font-size: 35px; font-weight: bold;">
                    Your Cart
                </v-card-title>
                ...
                <v-card-text v-if="cartItems.length && 10000 - calcTotalPrice <= 0" class="px-0 pt-2">You order now is included Free Shipping</v-card-text>
                <v-card-text v-if="!cartItems.length" class="px-0 pt-2 text-center">You cart is empty!</v-card-text>
                <v-card-actions v-if="!cartItems.length" class="px-0 justify-center">
                    <v-btn class="mx-0 mt-5" width="300" style="text-transform: none; border-radius: 30px;" variant="outlined" @click="$router.push({ name: 'home'})" color="blue" density="compact" height="45">Continue Shopping</v-btn>
                </v-card-actions>
            </v-col>
            ...
            <v-col cols="12" lg="4" md="4" class="px-1 px-lg-4" v-if="cartItems.length">
                <v-card elevation="0">
                    ...
                    <!-- <div class="states mt-4">
                        ...
                        <input class="pa-3" width="43%" style="border: 1px solid #000; border-radius: 30px; font-size: 14px; margin-left: 1%;" type="text">
                    </div> -->
                    <v-card-actions class="py-5 px-0">
                        <v-btn style="text-transform: none; border-radius: 30px; border-color: #f9f9f9;" color="blue" variant="outlined" density="compact" height="45" class="w-100 bg-primary">Check Out</v-btn>
                    </v-card-actions>
                    ...
                    <v-card-actions class="pt-5 pb-3 px-0">
                        <v-btn style="text-transform: none; border-color: #f9f9f9;" color="blue" variant="outlined" density="compact" height="45" class="w-100 bg-primary" @click="toCheckout">Proceed To Checkout</v-btn>
                    </v-card-actions>
                    <v-card-actions class="pb-5 px-0">
                        <v-btn style="text-transform: none;" variant="outlined" @click="$router.push({ name: 'home'})" color="blue" density="compact" height="45" class="w-100">Continue Shopping</v-btn>
                    </v-card-actions>
                </v-card>
            </v-col>
        </v-row>
