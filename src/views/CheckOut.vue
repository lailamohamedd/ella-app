                    ...
                    <v-card color="grey-lighten-3 right-card" width="100%" elevation="0">
                        <v-card color="transparent" class="d-flex justify-space-between last-card mb-3 align-center" elevation="0" width="100%" v-for="item in cartItems" :key="item.id">
                            ...
                            <v-badge :content="item.quantity" color="grey-darken-1">
                                <img :src="item.thumbnail" width="50" height="50" class="border-radius-2" alt="product image">
                            </v-badge>
                            <!-- End Quantity Badge -->
                            <!-- Start Title Parent -->
                            <div class="title-parent flex-grow-1">
                                <v-card-title class="item-title py-0">{{ item.title }} Sample-{{ item.category }} for sale</v-card-title>
                                <v-card-text class="item-cat">{{ item.category }}</v-card-text>
                            </div>
                             <!-- End Title Parent -->
                            <!-- Start Pricy -->
                        ...
                        <!-- Start Total Price -->
                        <v-card-text class="d-flex align-center justify-space-between font-weight-bold"><span>Total</span><span>${{ calcTotalPrice }}</span></v-card-text>
                        <!-- End Total Price -->
                    </v-card>
                </v-col>
            </v-row>
